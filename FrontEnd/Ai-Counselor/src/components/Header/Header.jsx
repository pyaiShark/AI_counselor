        ...
        <>
            ...
            <Drawer open={drawerOpen} onClose={() => setDrawerOpen(false)}>
                <div className="flex flex-col space-y-4">
                    <Link to="/" onClick={() => setDrawerOpen(false)} className="text-lg font-medium hover:text-primary">
                        Home
                    </Link>
                    <Link to="/features" onClick={() => setDrawerOpen(false)} className="text-lg font-medium hover:text-primary">
                        Features
                    </Link>
                    <Link to="/about" onClick={() => setDrawerOpen(false)} className="text-lg font-medium hover:text-primary">
                        About Us
                    </Link>
